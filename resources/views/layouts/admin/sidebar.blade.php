        ...
        <ul class="sidebar-menu">
            ...
            {{--</span>--}}
                ...
                {{--<ul class="treeview-menu">--}}
                    {{--<li><a href="AdminLTE-2.3.11/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>--}}
                    {{--<li class="active"><a href="AdminLTE-2.3.11/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            {{--<li class="treeview">--}}
                {{--<a href="#">--}}
