...
<div class="login-box">
    <div class="login-logo">
        <a href="AdminLTE-2.3.11/index2.html"><b>Licenta</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <div class="social-auth-links text-center">
            <a href="{{$facebook_login_url}}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
                Facebook</a>
